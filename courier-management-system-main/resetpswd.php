...
<head>
    ...
    <style>
        body
        {
        /* background-image:url('images/Courier-Services-Business-Plan.webp');
...
<body>
    <h1 align='center' style="margin: 15px; font-weight: bold;font-family:'Times New Roman', Times, serif">Courier Managment System</h1><hr/>
    <P align='center' style="font-weight: bold; font-family:'Times New Roman', Times, serif">The Fastest Courier Service Ever</P>
